...
internal sealed class ToSWindow : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        var tosContent = this.TOSContent == null ? "Please wait for the user agreement...." : this.TOSContent;
        ...
        ImGui.Checkbox("I have read the above and agree.", ref this.tosRead);
        ...
        ImGui.SameLine();
        var disagreeText = "I don't agree.";
